...
if($_POST[setid]==$_SESSION[setid])
{
	if(isset($_POST[submit]))
	{
		if(isset($_GET[updid]))
		{
			$sqlupde="UPDATE visitors SET fname='$_POST[first]',lname='$_POST[last]',email_id='$_POST[login]',dob='$_POST[dob]',visit_password='$_POST[password]',visit_adrs='$_POST[addrs]',contact_num='$_POST[cnumber]',mobile_no='$_POST[mnumber]',status='$_POST[status]'	 where visitor_id='$_GET[updid]'";
				...
				{
				echo "<font color='#FFFFFF'><h2>Lodge details updated successfully...</center></h2></font>";
				}	
		}
		else
		{			
	
$sqlinss = "INSERT INTO visitors(fname,lname,email_id,dob,visit_password,visit_adrs,contact_num,mobile_no,status) values('$_POST[first]','$_POST[last]','$_POST[login]','$_POST[dob]','$_POST[password]','$_POST[addrs]','$_POST[cnumber]','$_POST[mnumber]','$_POST[status]')";
$result=mysqli_query($dbconnection, $sqlinss);		
	if(!$result)
		...
		{
			echo "<font color='#FFFFFF'><h2>Visitor Record inserted successfully...</center></h2></font>";
		}
	}
}
}
$updselrec = "SELECT * FROM visitors where visitor_id='$_GET[updid]'";
